...
<?php
    $selecaoescova = $_POST['selecaoescova'];

    switch ($selecaoescova){
        case "escova":
            echo "Você agendou uma ESCOVA!";
        break;
        case "babyliss":
            echo "Você agendou um BABYLISS!";
        break;
        case "simples":
            echo "Você agendou um penteado SIMPLES!";
        break;
        case "elaborado":
            echo "Você agendou um penteado ELABORADO";
        break;
    }
